...
class PembelianResource extends Resource
{
                ...
                Wizard::make([
                    ...
                    ->schema([
                        Repeater::make('items')
                            ...
                            ->columns(4)
                            ->createItemButtonLabel('Tambah Barang Masuk')
                            ->minItems(1),
                            ...
                            Forms\Components\Actions\Action::make('Proses Masuk Barang')
                                ->action(function ($get, $set) {
                                    ...
                                    $pembelian = Pembelian::updateOrCreate(
                                        ['no_faktur_beli' => $get('no_faktur_beli')],
                                        [
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('no_faktur_beli')->label('No Faktur')->searchable(),
